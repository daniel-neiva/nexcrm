    ...
    return (
        <div className="p-8 max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-3xl font-bold text-white">Atalhos</h1>
            </div>
            ...
            <div className="apple-glass-panel p-12 rounded-[2.5rem] border border-white/10 flex flex-col items-center justify-center text-center">
                <div className="w-20 h-20 rounded-3xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center mb-6">
                    <Keyboard className="w-10 h-10 text-indigo-400" />
                </div>
                <h2 className="text-xl font-bold text-white mb-2">Página em Desenvolvimento</h2>
                <p className="text-white/40 max-w-sm">Configure atalhos de teclado e respostas rápidas com "/" para agilizar seu atendimento.</p>
            </div>
        </div>
    )
}
